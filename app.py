...
def predictRoute():
    try:
        ...
        os.system("cd yolov9/ && python detect.py --weights best.pt --img 416 --conf 0.1 --source ../data/inputImage.jpg")
...
def predictLive():
    try:
        os.system("cd yolov9/ && python detect.py --weights my_model.pt --img 416 --conf 0.5 --source 0")
        os.system("rm -rf yolov9/runs")
