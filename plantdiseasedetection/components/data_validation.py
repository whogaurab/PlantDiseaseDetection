...
from plantdiseasedetection.entity.config_entity import DataValidationConfig
from plantdiseasedetection.entity.artifacts_entity import (DataValidationArtifact,
