...
from plantdiseasedetection.components.data_validation import DataValidation
from plantdiseasedetection.components.model_trainer import ModelTrainer
...
from plantdiseasedetection.entity.artifacts_entity import (DataIngestionArtifact,
